...
import { ActionGetRentalAnalysis } from "../../redux/action/api/cycles/rental/analysis";
import { useEffect } from "react";
import { StateAllRentalAnalysis } from "../../redux/stores/api/analysis/rental";
import { MapPin } from "lucide-react";

export default function RentalsAnalysis() {
  const dispatch = useAppDispatch();
  const stateAllRental = useAppSelector(StateAllRentalAnalysis);
  const data = stateAllRental?.data?.data;

  useEffect(() => {
    dispatch(ActionGetRentalAnalysis());
  }, []);
        ...
        <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
          ...
          >
            <div className="p-5 box">
              ...
              <div className="mt-1 text-base text-slate-500">Total Count</div>
            </div>
          </div>
        </div>
        {/* <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
        ...
        <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
          ...
          >
            <div className="p-5 box">
              ...
              <div className="mt-1 text-base text-slate-500">Show on Home</div>
            </div>
          </div>
        </div>
        <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
