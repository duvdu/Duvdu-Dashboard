...
export default function CopyrightsAnalysis({CopyrightContract}:any) {
      ...
      {CopyrightContract && 
        <div className="grid grid-cols-12 gap-6 mt-5 mb-8">    
            ...
            <div className="grid grid-rows-12 gap-6">
                <div className="grid grid-rows-12 gap-5 intro-y">
                  ...
                  >
                    <div className="p-5 box">
                      <div className="mt-6 text-3xl font-medium leading-8">
                      {CopyrightContract.totalPriceSum}
                      </div>
                      <div className="mt-1 text-base text-slate-500">
                        Total Price
                      </div>
          ...
          <div className="col-span-12 intro-y box lg:col-span-6">
            ...
            <div className="p-5">
              {CopyrightContract?.statusCounts && Object?.entries(CopyrightContract?.statusCounts).map(([key, value]: [string, any], index:number) => 
