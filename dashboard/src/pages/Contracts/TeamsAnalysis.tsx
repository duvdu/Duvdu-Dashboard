...
export default function TeamsAnalysis({TeamContracts}:any) {
  return (
    <Tab.Panel>
        {TeamContracts&& 
            ...
            <div className="col-span-12 intro-y box lg:col-span-6">
                ...
                <div className="p-5">
                {TeamContracts?.statusCounts && Object?.entries(TeamContracts?.statusCounts).map(([key, value]: [string, any],index:number) => 
