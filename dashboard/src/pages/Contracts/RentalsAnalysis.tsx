...
import fakerCopyrightContract from "../../utils/faker";
...
export default function RentalsAnalysis({RentalContract}:any) {
  return (
    <Tab.Panel>
      {RentalContract && 
      <>
      <div className="grid grid-cols-12 gap-6 mt-5 mb-8">    
        ...
        <div className="col-span-12 intro-y box lg:col-span-6">
          ...
          <div className="p-5">
            {RentalContract?.statusCounts && Object?.entries(RentalContract?.statusCounts).map(([key, value]: [string, any], index:number) => 
