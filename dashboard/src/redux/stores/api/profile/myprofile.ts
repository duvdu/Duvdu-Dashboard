...
import { KEY_MYPROFILE } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_MYPROFILE, async () => { });
...
export const StateMyProfile = (state: RootState) => state.myprofile;
