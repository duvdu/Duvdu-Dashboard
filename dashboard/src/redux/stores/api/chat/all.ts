...
import { KEY_CHAT, KEY_CHAT_GETALL } from "../../../constants/actionTypes";
...
export const AsyncThunkRef = createAsyncThunk(KEY_CHAT_GETALL, async () => { });
...
export const StateAllChat = (state: RootState) => state.allchat;
