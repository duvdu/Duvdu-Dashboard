...
import { KEY_UPDATE_COMPLAINT } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_UPDATE_COMPLAINT, async () => { });
...
export const StateUpdateCompliant = (state:any) => state.updateComplaint;
