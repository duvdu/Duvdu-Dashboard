...
import { KEY_GET_COMPLAINT_BY_ID } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_GET_COMPLAINT_BY_ID, async () => { });
...
export const StateGetComplaintById = (state:any) => state.getComplaintById;
