...
export const AsyncThunkRef = createAsyncThunk(SEND_NOTIFICATIONS_TO_ALL_USERS, async () => { });
...
export const StateSendNotificationsToAllUsers = (state:any) => state.sendNotificationsToAllUsers;
