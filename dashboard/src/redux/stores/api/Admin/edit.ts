...
import { KEY_UPDATE_ADMIN } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_UPDATE_ADMIN, async () => { });
...
export const StateEditAdmin = (state:any) => state.editAdmin;
