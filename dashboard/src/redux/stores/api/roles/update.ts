...
import { KEY_UPDATE_ROLE } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_UPDATE_ROLE, async () => { });
...
export const StateUpdateRole = (state: RootState) => state.updateRole;
