...
import { KEY_GET_ROLE_BY_ID } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_GET_ROLE_BY_ID, async () => { });
...
export const StateGetRoleById = (state: RootState) => state.getRoleById;
