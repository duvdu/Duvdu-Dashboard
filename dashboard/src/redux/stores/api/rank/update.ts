...
import { KEY_UPDATE_RANK } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_UPDATE_RANK, async () => { });
...
export const StateUpdateRank = (state:any) => state.updateRank;
