...
import { KEY_GET_RANKS } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_GET_RANKS, async () => { });
...
export const StateGetAllRanks = (state:any) => state.getAllRanks;
