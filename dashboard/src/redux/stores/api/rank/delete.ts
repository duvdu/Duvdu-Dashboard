...
import { KEY_DELETE_RANK } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_DELETE_RANK, async () => { });
...
export const StateDeleteRank = (state:any) => state.deleteRank;
