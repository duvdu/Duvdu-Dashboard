...
import { KEY_GET_PLATFORMS } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_GET_PLATFORMS, async () => { });
...
export const StateGetAllPlatforms = (state:any) => state.getAllPlatforms;
