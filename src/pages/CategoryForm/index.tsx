                                ...
                                <Popover.Panel placement="bottom-start">
                                  <div className="p-2">
                                    <div>
                                      ...
                                      <FormInput onChange={handleEnglishChange} type="text" className="flex-1 mt-2" placeholder="tag ..." />
                                    </div>
                                    <div className="mt-3">
                                      <div className="text-xs text-left">Arabic</div>
                                      <FormInput onChange={handleArabicChange} type="text" className="flex-1 mt-2" placeholder="tag ..." />
                                    </div>
