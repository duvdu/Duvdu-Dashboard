...
import Portfolios from "../pages/cycles/portfolios";
import Studios from "../pages/cycles/studios";
import CopyRighter from "../pages/cycles/copyRighter";
import Producer from "../pages/cycles/producer";
