...
import { KEY_DELETE_ROLE } from "../../../constants/actionTypes";
import { fulfilledCase, pendingCase, rejectedCase } from "../commanApi";
import DataState from "../../../moduls";

export const AsyncThunkRef = createAsyncThunk(KEY_DELETE_ROLE, async () => { });
...
export const StateDeleteRole = (state: RootState) => state.deleteRole;
